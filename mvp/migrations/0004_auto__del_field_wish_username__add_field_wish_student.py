...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Wish.username'
        db.delete_column('mvp_wish', 'username_id')

        # Adding field 'Wish.student'
        db.add_column('mvp_wish', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mvp.Student']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Wish.username'
        db.add_column('mvp_wish', 'username',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['mvp.Student']),
                      keep_default=False)

        # Deleting field 'Wish.student'
        db.delete_column('mvp_wish', 'student_id')
    ...
    models = {
        ...
        'mvp.wish': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mvp.Student']"}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mvp.Tag']", 'symmetrical': 'False'})
        }
    }
