...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Tag.subject'
        db.delete_column('mvp_tag', 'subject_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table('mvp_subject', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=11, null=True)),
        ))
        db.send_create_signal('mvp', ['Subject'])

        # Adding field 'Tag.subject'
        db.add_column('mvp_tag', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mvp.Subject'], null=True),
                      keep_default=False)
