...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('mvp_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True, null=True))
        # Adding unique constraint on 'Tag', fields ['name']
        db.create_unique('mvp_tag', ['name'])


        # Changing field 'Subject.name'
        db.alter_column('mvp_subject', 'name', self.gf('django.db.models.fields.CharField')(max_length=11, unique=True, null=True))
        # Adding unique constraint on 'Subject', fields ['name']
        db.create_unique('mvp_subject', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Subject', fields ['name']
        db.delete_unique('mvp_subject', ['name'])

        # Removing unique constraint on 'Tag', fields ['name']
        db.delete_unique('mvp_tag', ['name'])


        # Changing field 'Tag.name'
        db.alter_column('mvp_tag', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=50))

        # Changing field 'Subject.name'
        db.alter_column('mvp_subject', 'name', self.gf('django.db.models.fields.CharField')(default=0, max_length=11))
    ...
    models = {
        ...
        'mvp.wish': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mvp.Tag']", 'symmetrical': 'False'}),
            'username': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['mvp.Student']"})
        }
    }
