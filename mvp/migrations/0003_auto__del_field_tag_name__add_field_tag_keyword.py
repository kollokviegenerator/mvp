...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('mvp_tag', 'name')

        # Adding field 'Tag.keyword'
        db.add_column('mvp_tag', 'keyword',
    ...
    def backwards(self, orm):
        ...
        db.add_column('mvp_tag', 'name',
                      self.gf('django.db.models.fields.CharField')(unique=True, max_length=50, null=True),
                      keep_default=False)

        # Deleting field 'Tag.keyword'
        db.delete_column('mvp_tag', 'keyword')
